        ...
        <div className={style.hero}>
          ...
          <div className={style.content}>
            ...
            <div className={style.decs}>
              MaxRise - це про здоров’я, тож результат гарантовано отримують
              всі. Незалежно від вашого досвіду та фізичної підготовки, ви
              знайдете відповідні рекомендації для розвитку вашого тіла та духу.
            </div>
